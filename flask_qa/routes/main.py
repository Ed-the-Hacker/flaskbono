...
from flask_qa.models import Usuario, Bono
...
def index():
    #listas
    usuario1 = Usuario(id=1,nombre='daniel',departamento='gerencia')
    bono1 = Bono(id=1,cantidad=20.5,departamento='gerencia')
    usuario2 = Usuario(id=2,nombre='pedro',departamento='sistemas')
    bono2 = Bono(id=2,cantidad=50,departamento='sistemas')
